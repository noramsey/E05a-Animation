...
SCREEN_WIDTH = 640 #these three lines are variables the program uses to build the window.
SCREEN_HEIGHT = 480
SCREEN_TITLE = "Move Mouse Example"


class Ball: #the class of 'Ball' is being defined, it contains the aparameters to create the object known as 'Ball'
